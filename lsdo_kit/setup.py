...
list_of_pyx_names = [
    ...
    # ('geometry', 'cython', 'get_open_uniform'),
    # ('geometry', 'cython', 'get_open_uniform_py'),
    # ('geometry', 'cython', 'basis0'),
    # ('geometry', 'cython', 'basis1'),
    # ('geometry', 'cython', 'basis2'),
    # ('geometry', 'cython', 'basis_matrix_curve'),
    # ('geometry', 'cython', 'basis_matrix_curve_py'),
    # ('geometry', 'cython', 'basis_matrix_surface'),
    # ('geometry', 'cython', 'basis_matrix_surface_py'),
    # ('geometry', 'cython', 'basis_matrix_volume'),
    # ('geometry', 'cython', 'basis_matrix_volume_py'),
    # ('geometry', 'cython', 'surface_projection'),
    # ('geometry', 'cython', 'surface_projection_py'),
    # ('geometry', 'cython', 'volume_projection'),
    # ('geometry', 'cython', 'volume_projection_py'),
    # ('geometry', 'cython', 'curve_projection'),
    # ('geometry', 'cython', 'curve_projection_py'),
...
for name_list in list_of_pyx_names:
    ext_name = 'lsdo_kit'
    source_name = 'lsdo_kit'
    packages.append('{}.{}'.format('lsdo_kit', name_list[0]))
