...
from lsdo_kit.design.design_geometry.utils.io.step_io import read_openvsp_stp, write_step
...
from lsdo_kit.design.design_geometry.core.pointset_functions import add_pointsets, subtract_pointsets
...
class DesignGeometry:
    ...
    def perform_linear_interpolation(self, pointset_start, pointset_end, shape, output_parameters=np.array([0]), offset=np.array([0., 0., 0.])):       
        return perform_linear_interpolation(self, pointset_start, pointset_end, shape)
