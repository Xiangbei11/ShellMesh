...
path_name = 'CAD/'
file_name = 'eVTOL_wing_structure.stp'
#file_name = 'eVTOL.stp'
...
top_leading_root = np.array([185.,40.,160.]) + np.array([0.,-20.,0.])
top_trailing_root = np.array([215.,40.,160.]) + np.array([0.,-20.,0.])
top_leading_tip = np.array([153.5,190.,160.]) + np.array([0.,24.,0.])
top_trailing_tip = np.array([171.5,190.,160.]) + np.array([0.,22.,0.])

bot_leading_root = np.array([185.,40.,110.]) + np.array([0.,-20.,0.])
bot_trailing_root = np.array([215.,40.,110.]) + np.array([0.,-20.,0.])
bot_leading_tip = np.array([153.5,190.,110.]) + np.array([0.,24.,0.])
bot_trailing_tip = np.array([171.5,190.,110.]) + np.array([0.,22.,0.])
