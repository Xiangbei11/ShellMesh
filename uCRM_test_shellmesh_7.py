...
for i in range(111,157):
    if i == 125 or i ==123:
        ...
        if i == 114:
            print('i==115')
            print(len(test_points),test_points)  
            test_points[10,:] = np.array([32360.0390864,3185.8868092,3155.9209041])
            test_points[11,:] = np.array([32360.0390864,3185.8868092,4387.96491738])                 
...
shell_mesh.construct_whole_structure_optmesh('CAD_uCRM_shellmesh_7')
vd_mesh = []
vd_points = []
count = 0
