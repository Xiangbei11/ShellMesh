...
for pointset in OML_ctrl_pointset_list_wingbox_side_11:
    print(pointset.pointset_id, pointset.name)
OML_pointset_list[104].shape= np.array([11, 11, 3])
ctrl_pointset_105 = geo.fit_bspline_ctrl_pointsets([OML_pointset_list[104]])
print(ctrl_pointset_105[0].pointset_id,ctrl_pointset_105[0].name)
num_points_u0, num_points_v0, num_points_u1, num_points_v1 = 10, 4, 10, 4
intersection_list = [[386,ctrl_pointset_105[0].pointset_id,num_points_u0,num_points_v0,num_points_u1,num_points_v1,'v1','T']]
