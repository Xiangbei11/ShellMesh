...
constrained_node_indices += [29,30]
constrained_node_indices += [31,32,33]
constrained_node_indices += [34,35,36,37,38]
constrained_node_indices += [39,40,41,42,43,44,45]
constrained_node_indices += [32,247]
constrained_node_indices += [37,248]
constrained_node_indices += [43,248]
constrained_node_indices += [44,248]
...
shell_mesh.construct_whole_structure_optmesh('CAD_uCRM_shellmesh_5')
vd_mesh = []
vd_points = []
count = 0
