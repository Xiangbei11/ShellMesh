...
vd_points2 = vedo.Points(points/scale, r=30, c='red',alpha = 0.5)
vd_plotter1 = vedo.Plotter()
vd_plotter1.show(vd0,vd2,vd3,vd_points2,'000', axes=1, viewup="z", interactive = True)
exit()
...
#points = vedo.Points(self.vertexCoords[self.fixedvert[[30,29]],:], r=25, c='blue',alpha = 0.3)
...
connectivity = np.copy(B['triangles'])
#rib48_indices_updated [28, 30, 247, 33, 248, 38, 45]
...
constrained_node_indices += rib48_indices_updated #28, 30, 246, 33, 247, 38, 44
constrained_node_indices += rib49_indices

constrained_node_indices += [30,32]
# constrained_node_indices += [31,32,33]
# constrained_node_indices += [34,35,36,37,38]
# constrained_node_indices += [39,40,41,42,43,44]

constrained_node_indices += [32,246]
constrained_node_indices += [37,247]
constrained_node_indices += [42,49]
...
# shell_mesh.construct_whole_structure_optmesh('CAD_uCRM_shellmesh_6')
vd_mesh = []
vd_points = []
count = 0
